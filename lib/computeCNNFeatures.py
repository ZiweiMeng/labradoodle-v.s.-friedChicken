...
def computeCnnFeatures(image_dir='../data/test/',save_dir='../output/orig_test_cnn_features.csv'):
    # set parameters
    ...
    start_train = time() 
    features = InceptionV3_model.predict_generator(data_generator, data_generator.nb_sample)
    end_train = time()
